...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.7.4"])
      ...
      s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.10.0", "< 2.0"])
      ...
      s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.7.4"])
      ...
      s.add_dependency(%q<xcodeproj>.freeze, [">= 1.10.0", "< 2.0"])
